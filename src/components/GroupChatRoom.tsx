...
const GroupChatRoom: React.FC<{ group: Group }> = ({ group }) => {
  ...
  const uploadImageToImgbb = async (file: File): Promise<string> => {
    try {
      console.log("Starting group image upload...", file.name, file.size);
        ...
        {loading ? (
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Start the group conversation</p>
              <p className="text-xs text-muted-foreground mt-1">Send a message to get everyone talking</p>
            </div>
          </div>
        ) : (
          messages.map((msg) => {
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-3 bg-muted/30 rounded-lg">
                  ...
                  <span className="text-sm">
                    {group.members.length} members active
                  </span>
                </div>
                ...
                <div className="p-3 bg-muted/30 rounded-lg">
                  <h3 className="text-sm font-medium mb-2">Group ID</h3>
